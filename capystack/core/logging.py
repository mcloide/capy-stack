"""
Logging configuration for CapyStack.
...
def setup_logging():
    ...
    # Create logger
    logger = logging.getLogger('capystack')
...
def get_logger(name: str = 'capystack') -> logging.Logger:
...
class DeploymentLogger:
    ...
    def log(self, level: str, message: str, step: str = None, **kwargs):
        ...
        if self.redis_client:
            ...
            channel = f'capystack.logs.{self.deployment_id}'
