// CapyStack JavaScript Application
...
window.CapyStack = {
    ...
    deployments: {
        ...
        getStatus: function(deploymentId) {
            return CapyStack.utils.apiRequest(`/api/deployments/${deploymentId}/status`);
        },
        
        // Cancel deployment
        cancel: function(deploymentId) {
            return CapyStack.utils.apiRequest(`/api/deployments/${deploymentId}/cancel`, {
                method: 'POST'
            });
        },
        ...
        refresh: function(deploymentId) {
            return CapyStack.utils.apiRequest(`/api/deployments/${deploymentId}`);
        }
    },
    ...
    refs: {
        ...
        getBranches: function() {
            return CapyStack.utils.apiRequest('/api/refs/branches');
        },
        
        // Get tags
        getTags: function() {
            return CapyStack.utils.apiRequest('/api/refs/tags');
        },
        
        // Get releases
        getReleases: function() {
            return CapyStack.utils.apiRequest('/api/refs/releases');
        }
    },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('error', function(event) {
        ...
        CapyStack.utils.showNotification('An unexpected error occurred', 'error');
    });
    ...
    window.addEventListener('beforeunload', function() {
        CapyStack.realtime.disconnectAll();
    });
