"""
Configuration management for CapiStack.

This module handles all configuration settings for the CapiStack application,
...
class Config:
    ...
    # Core settings
    APP_NAME = os.getenv('APP_NAME', 'CapiStack')
    ...
    DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql+psycopg://capistack:capistack@127.0.0.1:5432/capistack')
    ...
    WORK_DIR = os.getenv('WORK_DIR', '/tmp/capistack/runs')
